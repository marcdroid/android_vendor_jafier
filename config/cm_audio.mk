...
ALARM_PATH := vendor/jafier/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/jafier/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/jafier/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/jafier/prebuilt/common/media/audio/ui
